...
:root {
  --base00: #161b1d; /* Black (Background) - Default Background */
  --base01: #1c1f24; /* (Darkest Gray) - Lighter Background (Used for status bars) */
  --base02: #2c313a; /* (Dark Gray) - Selection Background */
  --base03: #434852; /* Bright Black (Gray) - Comments, Invisibles, Line Highlighting */
  --base04: #565c64; /* (Light Gray) - Dark Foreground (Used for status bars) */
  --base05: #abb2bf; /* White - Default Foreground, Caret, Delimiters, Operators */
  --base06: #b6bdca; /* (Lighter White) - Light Foreground */
  --base07: #c8ccd4; /* Bright White - The Lightest Foreground */
  --base08: #ef596f; /* Red and Bright Red - Variables, XML Tags, Markup Link Text, Markup Lists, Diff Deleted */
  --base09: #d19a66; /* (Orange) - Integers, Boolean, Constants, XML Attributes, Markup Link Url */
  --base0A: #e5c07b; /* Yellow and Bright Yellow - Classes, Markup Bold, Search Text Background */
  --base0B: #89ca78; /* Green and Bright Green - Strings, Inherited Class, Markup Code, Diff Inserted */
  --base0C: #2bbac5; /* Cyan and Bright Cyan - Support, Regular Expressions, Escape Characters, Markup Quotes */
  --base0D: #61afef; /* Blue and Bright Blue - Functions, Methods, Attribute IDs, Headings */
  --base0E: #d55fde; /* Magenta and Bright Magenta - Keywords, Storage, Selector, Markup Italic, Diff Changed */
  --base0F: #be5046; /* (Dark Red or Brown) - Deprecated, Opening/Closing Embedded Language Tags, e.g. <?php ?> */
