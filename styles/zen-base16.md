...
# ==Zen Base16== Theme
>
> **_A theme for SilverBullet inspired by [Zen](https://zen-browser.app/) and adapted to use Base16 syntax._**
...
html[data-theme="dark"] {
  /* Base16 ZEN Dark Palette */
  --base00: #1F1F1F; /* surface-base */
  --base01: #1C1C1C; /* surface-lower */
  --base02: #363636; /* surface-raised */
  --base03: #6E6E7A; /* text-tertiary */
  --base04: #D1CFC0; /* text-secondary */
  --base05: #E8E8E8; /* text-primary */
  --base06: #F5F5F5; /* lighter text */
  --base07: #FFFFFF; /* white */
  --base08: #EF4444; /* Red */
  --base09: #F76F53; /* Orange (Accent Primary) */
  --base0A: #F59E0B; /* Yellow */
  --base0B: #10B981; /* Green */
  --base0C: #26B5CE; /* Cyan */
  --base0D: #60A5FA; /* Blue */
  --base0E: #8B5CF6; /* Purple (Accent Secondary) */
  --base0F: #A1A1AA; /* Brown/Other */
}
```
...
:root, html, body {
  ...
  --highlight-color: color-mix(in srgb, #5E6AD2, transparent 70%);
  ...
  --subtle-background-color: color-mix(in srgb, #8F8F9D, transparent 90%);
  ...
  --top-sync-error-background-color: color-mix(in srgb, #F59E0B, transparent 90%);
  ...
  --notification-info-background-color: color-mix(in srgb, #26B5CE, transparent 90%);
  --notification-error-background-color: color-mix(in srgb, #EF4444, transparent 90%);
  ...
  --editor-caret-color: var(--accent-primary);
    /* Linear
  ...
  --editor-hashtag-background-color: color-mix(in srgb, #5E6AD2, transparent 85%);
...
/* Linear
  ...
  --editor-blockquote-background-color: color-mix(in srgb, #8F8F9D, transparent 95%);
  ...
  --table-even-background-color: color-mix(in srgb, #1C1C21, transparent 70%);
  ...
  --color-success-bg: color-mix(in srgb, #22C55E, transparent 90%);
  --color-error: #EF4444;
  --color-error-bg: color-mix(in srgb, #EF4444, transparent 90%);
  --color-warning: #F59E0B;
  --color-warning-bg: color-mix(in srgb, #F59E0B, transparent 90%);
  --color-info: #60A5FA;
  --color-info-bg: color-mix(in srgb, #60A5FA, transparent 90%);

  /* Accent color with opacity levels */
  --accent-primary-10: color-mix(in srgb, var(--accent-primary), transparent 90%);
  --accent-primary-15: color-mix(in srgb, var(--accent-primary), transparent 85%);
  --accent-primary-20: color-mix(in srgb, var(--accent-primary), transparent 80%);
  --accent-primary-30: color-mix(in srgb, var(--accent-primary), transparent 70%);
  --accent-primary-50: color-mix(in srgb, var(--accent-primary), transparent 50%);
  --accent-primary-80: color-mix(in srgb, var(--accent-primary), transparent 20%);
  --accent-primary-100: var(--accent-primary);
...
html[data-theme="dark"] {
  /* Theme colors mapped to Base16 */
  --accent-primary: var(--base09);
  --accent-secondary: var(--base0E);
  --surface-base: var(--base00);
  --surface-lower: var(--base01);
  --surface-raised: var(--base02);
  --surface-hover: color-mix(in srgb, var(--base02), black 10%);
  --border-default: var(--base02);
  --text-primary: var(--base05);
  --text-secondary: var(--base04);
  --text-tertiary: var(--base03);
  --selection-bg: var(--surface-base);
  --selection-text: var(--base04);
  --editor-code-background-color: var(--base01);
  --code-border-subtle: var(--base03);
  --editor-table-hover-background-color: color-mix(in srgb, var(--base07), transparent 90%);
  --color-contrast: #000000;

    /* Code syntax highlighting */
  --syntax-keyword: var(--base0E);
  --syntax-string: var(--base0B);
  --syntax-string-alt: var(--base0B);
  --syntax-number: var(--base09);
  --syntax-boolean: var(--base09);
  --syntax-variable: var(--base0D);
  --syntax-type: var(--base0A);
  --syntax-comment: var(--base03);
  --syntax-link: var(--base0D);
  --syntax-wiki-link: var(--base0E);
  --syntax-wiki-link-bg: color-mix(in srgb, var(--base0E), transparent 90%);
  --syntax-punctuation: var(--base05);
  --syntax-operator: var(--accent-primary);
  --syntax-literal: var(--base0B);
  --syntax-invalid: var(--base08);
  --syntax-emphasis: var(--base0A);
  --syntax-strong: var(--base0A);
  --syntax-strikethrough: var(--base03);
  --syntax-quote: var(--base0F);
}

html[data-theme="light"] {
  /* Base16 ZEN Light Palette */
  --base00: #FAF7F2; /* surface-base */
  --base01: #F0EBDD; /* surface-lower */
  --base02: #E8E3D4; /* surface-raised */
  --base03: #555555; /* text-tertiary */
  --base04: #4F4C42; /* text-secondary */
  --base05: #666359; /* text-primary */
  --base06: #333333; /* darker text */
  --base07: #000000; /* black */
  --base08: #DC2626; /* Red */
  --base09: #F76F53; /* Orange (Accent) */
  --base0A: #B45309; /* Yellow/Brown */
  --base0B: #047857; /* Green */
  --base0C: #065F46; /* Cyan/Teal */
  --base0D: #1E40AF; /* Blue */
  --base0E: #8B5CF6; /* Purple */
  --base0F: #6B7280; /* Brown/Gray */
  ...
  --surface-lower: var(--base01);
  --surface-raised: var(--base02);
  --surface-hover: color-mix(in srgb, var(--base02), black 5%);
  ...
  --syntax-keyword: var(--base0E);
  --syntax-string: var(--base0B);
  --syntax-string-alt: var(--base0C);
  --syntax-number: var(--base0A);
  --syntax-boolean: var(--base09);
  --syntax-variable: var(--base0D);
  --syntax-type: var(--base0A);
  --syntax-comment: var(--base0F);
  --syntax-link: var(--base0D);
  --syntax-wiki-link: var(--base0E);
  --syntax-wiki-link-bg: color-mix(in srgb, var(--base0E), transparent 90%);
  --syntax-punctuation: var(--base05);
  --syntax-operator: var(--base09);
  --syntax-literal: var(--base0B);
  --syntax-invalid: var(--base08);
  --syntax-emphasis: var(--base0A);
  --syntax-strong: var(--base05);
  --syntax-strikethrough: var(--base0F);
  --syntax-quote: var(--base0F);
}
```
...
#sb-main .cm-editor table {
  ...
  tbody {
    tr {
      ...
      &:nth-of-type(even) {
        background: var(--editor-table-even-background-color) !important;
      }
